	...
	@section('content')
		...
		<div class="view_schedule">
			...
			@else
				<div class="row">
					<div class="col">
						<h3 class="text-white">The tournament schedule will be posted on 7/8/2018 once registration has closed and bracket has been completed. If there is an odd number of teams, there will be play-in games for the teams who register last.</h3>
					</div>
				</div>
